...
#   timestamp: 2026-06-21T11:16:44+00:00
...
class CrosswordCell(BaseModel):
    row: Annotated[int, Field(description='0-indexed row within this grid.')]
    col: Annotated[int, Field(description='0-indexed column within this grid.')]
    blocked: Annotated[
        bool, Field(description='True if this cell is not part of any word.')
    ]
    letter: Annotated[
        str | None, Field(description='The kana at this cell. Null if blocked.')
    ] = None
    word_ids: Annotated[
        list[int] | None,
        Field(
...
class CrosswordWordEntry(BaseModel):
    id: Annotated[int, Field(description='Referenced by CrosswordCell.word_ids.')]
    word: Annotated[
        str,
        Field(
    ...
    row: Annotated[int, Field(description='0-indexed start row.')]
    col: Annotated[int, Field(description='0-indexed start column.')]
    direction: Direction


class CrosswordGrid(BaseModel):
    ...
    words: list[CrosswordWordEntry]
    decoy_kana: Annotated[
        list[str],
        Field(
